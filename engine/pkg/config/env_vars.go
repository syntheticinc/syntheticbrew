...
const (
	...
	EnvOAuthASEnabled       = "SYNTHETICBREW_OAUTH_AS_ENABLED"
	EnvOAuthIssuer          = "SYNTHETICBREW_OAUTH_ISSUER"
	EnvOAuthConsentURL      = "SYNTHETICBREW_OAUTH_CONSENT_URL"
	EnvOAuthASKeyPath       = "SYNTHETICBREW_OAUTH_AS_KEY_PATH"
)
